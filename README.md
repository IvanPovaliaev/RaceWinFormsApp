...
### ⚙️Настройки
В настроках можно изменить громкость фоновой музыки и громкость игровых звуков. Данные настройки сохраняются после выхода из приложения. Дополнительно сохраняется имя последнего игрока.
...
https://github.com/IvanPovaliaev/RaceWinFormsApp/assets/157638990/b5525819-3212-495b-bb75-56452db7eca3
